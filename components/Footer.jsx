...
const Footer = () => {
  return (
    <footer className="shadow dark:bg-gray-800 dark:text-rose-300 border-t-[0.5px]">
      <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
        <span className="self-center space-y-4 mx-2 text-sm">
          {" "}
          © {new Date().getFullYear()} Bump to Parenthood™
        </span>

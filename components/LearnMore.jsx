...
function LearnMore({ about }) {
  ...
  return (
    <div class="flex flex-wrap p-5 justify-center p-10 bg-gray-100 dark:bg-gray-800 dark:text-gray-200">
      ...
      <div class=" flex flex-col w-full h-2/3  md:w-1/2 justify-between gap-2 p-5">
        ...
        <p class="text-gray-600 mb-2 text-justify dark:text-gray-200">
         {shortDesc}
        </p>
